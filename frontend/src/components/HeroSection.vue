...
<section id="profil" class="container mx-auto px-6 py-20 flex flex-col md:flex-row items-center">
  <div class="md:w-1/2 mb-10 md:mb-0">
    ...
    200ms;">
      Halo, Saya <span class="text-blue-600">Fata Pureka</span>
    </h1>
    <p class="text-xl text-gray-600 mb-8 animate-slide-in-left" style="animation-delay: 400ms;">
      Mahasiswa Teknik Informatika Universitas Amikom Yogyakarta yang bersemangat dalam pengembangan web dan desain
      antarmuka.
    </p>
  ...
  <div class="md:w-1/2 flex justify-center animate-slide-in-right">
    <img :src="Fata" alt="Foto Profil" class="w-80 h-80 rounded-full object-cover shadow-lg">
  </div>
</section>
</template>

<script setup>
import Fata from '@/assets/Fata.jpeg'
</script>
